package com.fandi.jsonparsingdemo;
...
import com.fandi.jsonparsingdemo.models.MovieModel;
...
//                new JSONTask().execute("http://192.168.43.72/contact.php");
    }
    ...
    public class MovieAdapter extends ArrayAdapter{
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null){
                ...
                holder.rbMovieRating = (RatingBar) convertView.findViewById(R.id.rbMovieRating);
